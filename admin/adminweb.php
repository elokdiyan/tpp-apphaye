    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <?php
            ...
            }elseif ($_GET['module'] == 'tambah_vendor'){
              include "module/vendor/form_tambah.php";
            }elseif ($_GET['module'] == 'edit_vendor'){
              include "module/vendor/form_edit.php";
            } //.Vendor
            ...
            <div class="nk-sidebar">           
                <div class="nk-nav-scroll">
                    <ul class="metismenu" id="menu">
                        ...
                        <li>
                            <a href="adminweb.php?module=vendor">
                        ...
                        <li>
                            <a href="adminweb.php?module=pesanan">
