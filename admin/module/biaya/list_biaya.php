                    ...
                    <section class="content">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="box-body table-responsive no-padding">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?php echo $admin_url; ?>adminweb.php?module=edit_biaya&id_biaya_kirim=<?php echo $bia['id_biaya_kirim']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></button></i></a> <!-- Edit -->

                                                <a href="<?php echo $admin_url; ?>module/biaya/aksi_hapus.php?id_biaya_kirim=<?php echo $bia['id_biaya_kirim']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger"><i class="fa fa-power-off">
                                                </button></i></a> <!-- Hapus -->
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="box-footer">
                            <a href="<?php echo $base_url; ?>admin/adminweb.php?module=tambah_biaya">
                                <button class="btn btn-warning">Tambah biaya</button>
                            </a>
                        </div> <!-- /.Box Footer -->
                    </div> <!-- /.Box -->
                </div>
