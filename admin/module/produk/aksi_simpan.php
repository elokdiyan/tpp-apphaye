			...
			if ($ukuran_file <= 1000000) {
				if (move_uploaded_file($tmp_file, $path)) {
					$querySimpan = mysqli_query($koneksi, 
						"INSERT INTO tbl_produk (id_vendor, id_kategori, nama_produk, deskripsi, harga, gambar, slide, rekomendasi) 
						VALUES ('$idVendor','$idKategori','$namaProduk','$deskripsi','$hargaProduk','$nama_file','$slide','$rekomendasi')" );
