                                        ...
                                        <div class="active-member">
                                            ...
                                            <div class="box-body table-responsive no-padding">
                                             <table class="table table-xs mb-0">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="<?php echo $admin_url; ?>adminweb.php?module=edit_produk&id_produk=<?php echo $pro['id_produk']; ?>" class="btn btn-warning"><i class="fa fa-pencil"></button></i></a> <!-- Edit -->

                                                        <a href="<?php echo $admin_url; ?>module/produk/aksi_hapus.php?id_produk=<?php echo $pro['id_produk']; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" class="btn btn-danger"><i class="fa fa-power-off">
                                                        </button></i></a> <!-- Hapus -->
                                                    </div>
                                                </td>
                                            </tr>
